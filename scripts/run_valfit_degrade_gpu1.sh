...
LOG_DIR="${ROOT_DIR}/logs/valfit_degrade/${RUN_ID}"
SUMMARY_FILE="${LOG_DIR}/summary.tsv"

EXPERIMENTS=(
  "debug/valfit"
  "debug/valfit_degrade/reward_loose"
  "debug/valfit_degrade/terminal_weak"
  "debug/valfit_degrade/replay_more"
  "debug/valfit_degrade/combined_guardrail"
)
