...
class AnswerReachabilityExecution:
    def __init__(
        self,
        *,
    ...
    def _prepare_graph_with_fallback(
        ...
        *,
        ...
        try:
            ...
            return PreparedEvaluationGraph(
                batch=batch,
                prepared_batch=prepared_batch,
                analysis=self.empty_reachability_analysis(batch),
                invalid_start=True,
    ...
    def prepare_evaluation_graphs(
        ...
        *,
        on_invalid_start: Callable[[TrajectoryBatch], None] | None = None,
    ) -> list[PreparedEvaluationGraph]:
        prepared_graphs: list[PreparedEvaluationGraph] = []
                ...
                window_results.append(
                    build_rank_only_result(
                        ...
                        answer_mass_threshold=float(
                            self.inference_cfg.answer_mass_threshold
                        ),
                        support_mass_threshold=float(
                            self.inference_cfg.support_mass_threshold
                        ),
                        probe_count=0,
