...
class ExactReachabilityAnalyzer:
    ...
    def _build_analysis(
        ...
        *,
        batch: TrajectoryBatch,
        dp_result: _DynamicProgramResult,
    ) -> ExactReachabilityAnalysis:
