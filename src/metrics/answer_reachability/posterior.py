...
def support_targets(
    *,
    ...
    answer_upper_bounds: dict[int, float] | None = None,
) -> dict[int, float]:
    answer_mass = {
    ...
    return {
        answer_id: threshold
        * (
            float(answer_upper_bounds[answer_id])
            if answer_upper_bounds is not None and answer_id in answer_upper_bounds
...
def build_window_result(
    *,
    ...
    support_mass_reference: str = "discovered",
...
def build_rank_only_result(
    *,
    ...
    return SupportWindowResult(
        ...
        missed_gold_mass=float(analysis.gold_total_mass),
