...
def _trajectory_text(
    ...
    *,
    ...
    if not trajectory.edges:
        ...
        return f"(no_edge) --STOP--> {terminal}"
    parts: list[str] = []
...
def _trajectory_to_prompt_record(
    ...
    *,
    ...
    record = {
        "rollout_rank": int(trajectory.rollout_rank),
...
class ElasticWindowArtifactWriter:
    def __init__(
        self,
        *,
        output_dir: str | Path,
        split: str,
        artifact_name: str = "eval_trajectory_gfn",
    ...
    def write(
        self,
        *,
        results: Sequence[ElasticWindowResult],
        labels: Sequence[ElasticLabelRecord],
    ) -> dict[str, Path]:
        ...
        manifest = {
            ...
            "producer": "trajectory_gfn_artifact_writer",
        }
    ...
    def _build_prompt_record(
        ...
        return {
            ...
            "tail_rollout_mass": float(result.tail_rollout_mass),
...
__all__ = ["ElasticWindowArtifactWriter"]
