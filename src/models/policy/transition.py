...
from .types import ForwardActionDistribution, PreparedSearchBatch


@dataclass(frozen=True)
class ConstrainedForwardStep:
...
def compute_constrained_forward_step(
    *,
