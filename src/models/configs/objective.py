...
class SubTBConfig:
    ...
    def __post_init__(self):
        ...
        if self.doob_h_weight < 0.0:
            raise ValueError("doob_h_weight cannot be negative.")
