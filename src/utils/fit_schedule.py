...
class ResolvedPassFitSchedule:
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "val_every_passes": self.val_every_passes,
            "early_stopping_patience_passes": self.early_stopping_patience_passes,
            ...
            "train_batches_per_pass": self.train_batches_per_pass,
            "optimizer_steps_per_pass": self.optimizer_steps_per_pass,
            "max_steps": self.max_steps,
            "val_check_interval_batches": self.val_check_interval_batches,
            "early_stopping_patience_checks": self.early_stopping_patience_checks,
        }
...
def apply_resolved_pass_fit_schedule(
    ...
    with open_dict(cfg):
        ...
        if fit_schedule_cfg is None:
            cfg.fit_schedule = {"resolved": resolved.to_dict()}
        else:
            cfg.fit_schedule.resolved = resolved.to_dict()
