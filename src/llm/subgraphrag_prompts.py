...
# Prompt strings adapted from SubgraphRAG/reason/prompts.py for evaluation alignment.

DEFAULT_SUBGRAPHRAG_ICL_SYSTEM = (
...
DEFAULT_SUBGRAPHRAG_ICL_COT = (
    ...
    ' Return the most possible answers based on the given triplets by listing each answer on a separate line,'
...
DEFAULT_SUBGRAPHRAG_ICL_USER = """Triplets:
...
DEFAULT_SUBGRAPHRAG_ICL_ASSISTANT = """To find the year the team with mascot named Lou Seal won the World Series, we need to find the team with mascot named Lou Seal and then find the year they won the World Series.
