...
def test_artifact_writer_splits_prompt_and_label_records(tmp_path) -> None:
    ...
    writer = ElasticWindowArtifactWriter(output_dir=tmp_path, split="test")
    ...
    assert prompt_record["inference_mode"] == "sampled"
