        ...
        *,
        ...
        return PolicyStepOutput(
            ...
            edge_score_breakdown=EdgeScoreBreakdown(
                q_rel=torch.tensor([0.1, 0.9, 0.3], dtype=torch.float32),
                q_new=torch.tensor([0.2, 0.8, 0.4], dtype=torch.float32),
                q_candidate=torch.tensor([0.3, 0.7, 0.5], dtype=torch.float32),
